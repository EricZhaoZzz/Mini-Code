...
Key references:
- @C:/Users/Eric/dev/mini-code/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @C:/Users/Eric/dev/mini-code/.claude/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/Users/Eric/dev/mini-code/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/Users/Eric/dev/mini-code/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "C:/Users/Eric/dev/mini-code/.claude/get-shit-done/USER-PROFILE.md" "C:/Users/Eric/dev/mini-code/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/Users/Eric/dev/mini-code/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/Users/Eric/dev/mini-code/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @C:/Users/Eric/dev/mini-code/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to C:/Users/Eric/dev/mini-code/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to C:/Users/Eric/dev/mini-code/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/Users/Eric/dev/mini-code/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at C:/Users/Eric/dev/mini-code/.claude/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to C:/Users/Eric/dev/mini-code/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="C:/Users/Eric/dev/mini-code/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    C:/Users/Eric/dev/mini-code/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   C:/Users/Eric/dev/mini-code/.claude/commands/gsd/dev-preferences.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        C:/Users/Eric/dev/mini-code/.claude/CLAUDE.md
```
