...
```
Task(
  prompt="Read C:/Users/Eric/dev/mini-code/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Eric/dev/mini-code/.claude/get-shit-done/templates/VALIDATION.md`
