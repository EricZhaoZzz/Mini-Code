...
```markdown
Read C:/Users/Eric/dev/mini-code/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Users/Eric/dev/mini-code/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Users/Eric/dev/mini-code/.claude/agents/gsd-ui-checker.md for instructions.
