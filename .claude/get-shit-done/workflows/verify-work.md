...
<template>
@C:/Users/Eric/dev/mini-code/.claude/get-shit-done/templates/UAT.md
</template>
...
Read and follow `C:/Users/Eric/dev/mini-code/.claude/get-shit-done/workflows/transition.md`.
...
```bash
node "C:/Users/Eric/dev/mini-code/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @C:/Users/Eric/dev/mini-code/.claude/get-shit-done/workflows/diagnose-issues.md
