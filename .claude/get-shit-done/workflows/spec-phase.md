...
```bash
INIT=$(node "C:/Users/Eric/dev/mini-code/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/Eric/dev/mini-code/.claude/get-shit-done/templates/spec.md.
