...
<required_reading>
@C:/Users/Eric/dev/mini-code/.claude/get-shit-done/references/domain-probes.md
@C:/Users/Eric/dev/mini-code/.claude/get-shit-done/references/gate-prompts.md
@C:/Users/Eric/dev/mini-code/.claude/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
- Read and execute @C:/Users/Eric/dev/mini-code/.claude/get-shit-done/workflows/discuss-phase-power.md end-to-end
...
```bash
PROFILE_CONTENT=$(cat "C:/Users/Eric/dev/mini-code/.claude/get-shit-done/USER-PROFILE.md" 2>/dev/null || true)
```
...
2. For EACH user-selected gray area, spawn a Task() in parallel:
   ...
   Task(
     prompt="First, read @C:/Users/Eric/dev/mini-code/.claude/agents/gsd-advisor-researcher.md for your role and instructions.
...
**Full step-by-step instructions:** @C:/Users/Eric/dev/mini-code/.claude/get-shit-done/workflows/discuss-phase-power.md
